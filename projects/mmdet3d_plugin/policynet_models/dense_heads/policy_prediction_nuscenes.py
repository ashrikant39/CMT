...
from projects.mmdet3d_plugin.policynet_models.dense_heads.cmt_head import SeparateTaskHead, pos2embed, LayerNormFunction, GroupLayerNorm1d

# Custom Project Imports
from projects.mmdet3d_plugin.core.bbox.util import normalize_bbox
from projects.mmdet3d_plugin.policynet_models.dense_heads.Nuscenes_QTNET_prediction import (
...
class MaskQTNetHead(QTNetHead_Simple):
    def __init__(self,
                 ...
                 mask_hard=True,
                 mask_low_res_height=32,
                 mask_low_res_width=90,  # Low-resolution
                 mask_target_height=32,
                 mask_target_width=1080,   # High-resolution
