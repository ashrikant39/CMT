...
class CmtDetector(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        if img_feats is None:
            img_feats = [None]
        outs,queries, reference = self.pts_bbox_head(pts_feats, img_feats, img_metas)
    ...
    def simple_test_pts(self, x, x_img, img_metas, rescale=False):
        ...
        outs,queries, reference = self.pts_bbox_head(x, x_img, img_metas)
        ...
        return bbox_results, queries, reference
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False):
        ...
        if (pts_feats or img_feats) and self.with_pts_bbox:
            bbox_pts ,queries, reference = self.simple_test_pts(
        ...
        return bbox_list , queries, reference
