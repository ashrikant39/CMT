...
if __name__ == '__main__':
    ...
    # profile_memory=True,   # track mem allocs/deallocs
    # on_trace_ready=torch.profiler.tensorboard_trace_handler("work_dir/profiles"),
    # record_shapes=True,
    # with_stack=True) as prof:
    #     main()
    
    # prof.export_chrome_trace("work_dir/profiles/trace.json")
    main()
