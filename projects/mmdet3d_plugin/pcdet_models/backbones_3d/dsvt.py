...
class DSVT(BaseModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.input_layer = DSVTInputLayer(**input_layer_cfg)
        ...
        # save GPU memory
        self.use_torch_ckpt = use_checkpoint
        ...
        for stage_id in range(stage_num):
            ...
            if stage_id < stage_num-1:
                downsample_window = input_layer_cfg.get('downsample_stride', [])[stage_id]
